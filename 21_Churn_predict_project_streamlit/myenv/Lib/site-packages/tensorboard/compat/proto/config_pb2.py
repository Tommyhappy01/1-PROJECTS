...
_CONFIGPROTO_EXPERIMENTAL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='coordination_service', full_name='tensorboard.ConfigProto.Experimental.coordination_service', index=17,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='disable_functional_ops_lowering', full_name='tensorboard.ConfigProto.Experimental.disable_functional_ops_lowering', index=18,
